...
export const AM: Readonly<Partial<Record<MessageKey, string>>> = Object.freeze({
  'chapa.button': 'በቻፓ ገንዘብ አስገባ',
  'chapa.method': 'የክፍያ መንገድ',
  'transfer.title': 'ወደ ሌላ ሱቅ ቀሪ ሂሳብ ላክ',
  'transfer.fee': 'ክፍያ',
  'transfer.send': 'ቀሪ ሂሳብ ላክ',
  'bank_deposit.close': 'ዝጋ',
  'bank_deposit.button': 'ገንዘብ አስገባ',
  'bank_deposit.title': 'በባንክ ገንዘብ አስገባ',
  'bank_deposit.bank': 'ባንክ',
  'bank_deposit.reference': 'የክፍያ ማቲያ',
  'bank_deposit.expires': 'ከዚህ በፊት ይክፈሉ',
